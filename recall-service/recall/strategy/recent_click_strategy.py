...
## user clicks => kafka, flink => recent 1minute user clicks for each animeId => lsh find similar animeIds for watching animeIds
class RecentClickStrategy(RecallStrategy):
    ...
    def similar_animes_for(self, anime_id, n):    ## lsh to search similar animes
